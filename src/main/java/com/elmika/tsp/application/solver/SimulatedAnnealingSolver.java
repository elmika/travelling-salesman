...
/**
 * Improvement decorator that applies Simulated Annealing on top of any SolverStrategy.
 *
 ...
 * <p>Typical usage:
 * <pre>
 *   new SimulatedAnnealingSolver(new GreedyEdgeSolver())
 *   new SimulatedAnnealingSolver(new NearestNeighborSolver())
 * </pre>
 */
public class SimulatedAnnealingSolver implements SolverStrategy {
    ...
    public SimulatedAnnealingSolver(SolverStrategy inner) {
        this(inner, new Random());
    }

    /** Package-private constructor for deterministic testing. */
    SimulatedAnnealingSolver(SolverStrategy inner, Random random) {
        this.inner = inner;
        this.random = random;
    }
