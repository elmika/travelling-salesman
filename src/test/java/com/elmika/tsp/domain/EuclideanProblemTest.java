...
public class EuclideanProblemTest {
    ...
    public void create4xInvalidPointProblemThrowsExceptionTest() {
        assertThrows(IllegalArgumentException.class, this::create4xInvalidPointProblem);
    }

    @Test
    public void create4xOtherInvalidPointProblemThrowsExceptionTest() {
        assertThrows(IllegalArgumentException.class, this::create4xOtherInvalidPointProblem);
    }
